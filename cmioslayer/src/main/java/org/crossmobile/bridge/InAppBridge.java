...
public interface InAppBridge {
    ...
    public void requestValidProducts(Set<String> requestedProducts, NSSelector<ProductList> resultCallback);

    public void requestPayment(SKPayment payment, NSSelector<SKPaymentTransaction> resultCallback);
