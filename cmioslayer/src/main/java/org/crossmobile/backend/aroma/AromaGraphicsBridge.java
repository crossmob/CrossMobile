...
import org.crossmobile.backend.aroma.event.AromaEvent;
...
public class AromaGraphicsBridge extends DesktopGraphicsBridge<SkCanvas, SkMatrix> {
    ...
    @Override
    public GraphicsContext<SkMatrix> newGraphicsContext(SkCanvas aromaGraphicsContext, boolean isLive) {
        return aromaGraphicsContext == null ? new SkCanvas(window) : aromaGraphicsContext;
    }
    ...
    public void destroyCanvas(SkCanvas aromaGraphicsContext) {
        aromaGraphicsContext.finalize();
    }
    ...
    static native AromaEvent pollSDLEvents();
