...
#include <jni.h>
/* Header for class org_crossmobile_backend_aroma_SDLWindow */

#ifndef _Included_org_crossmobile_backend_aroma_SDLWindow
#define _Included_org_crossmobile_backend_aroma_SDLWindow
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_crossmobile_backend_aroma_SDLWindow
 * Method:    init
