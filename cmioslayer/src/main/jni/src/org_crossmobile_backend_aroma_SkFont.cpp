// JNI file org_crossmobile_backend_aroma_SkFont.c

#include"org_crossmobile_backend_aroma_SkFont.h"
#include "aroma.h"
...
JNIEXPORT void JNICALL Java_org_crossmobile_backend_aroma_SkFont_destroy
...
JNIEXPORT jlong JNICALL Java_org_crossmobile_backend_aroma_SkFont_init
...
JNIEXPORT jboolean JNICALL Java_org_crossmobile_backend_aroma_SkFont_postInit
...
JNIEXPORT jobject JNICALL Java_org_crossmobile_backend_aroma_SkFont_measureText
...
JNIEXPORT jdouble JNICALL Java_org_crossmobile_backend_aroma_SkFont_ascentText
  (JNIEnv * env, jclass clazz, jlong font, jstring text) {
  INIT();
  SkRect bounds;
  const char *ctext = env->GetStringUTFChars(text, 0);
