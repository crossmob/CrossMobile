...
// crossmobile.ios.addressbook.ABPeoplePickerNavigationController implementation
...
// (ABPeoplePickerNavigationController) @property(nonatomic, readwrite) ABAddressBookRef addressBook;
...
// (ABPeoplePickerNavigationController) @property(nonatomic, copy) NSArray<NSNumber *> *displayedProperties;
...
// (ABPeoplePickerNavigationController) @property(nonatomic, assign) id<ABPeoplePickerNavigationControllerDelegate> peoplePickerDelegate;
...
// direct binding of: @property(nonatomic, assign) id<ABPeoplePickerNavigationControllerDelegate> peoplePickerDelegate;
- (void) setPeoplePickerDelegate___crossmobile_ios_addressbook_ABPeoplePickerNavigationControllerDelegate:(id<ABPeoplePickerNavigationControllerDelegate>) peoplePickerDelegate 
{
    objc_setAssociatedObject(self, @selector(setPeoplePickerDelegate:), peoplePickerDelegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
