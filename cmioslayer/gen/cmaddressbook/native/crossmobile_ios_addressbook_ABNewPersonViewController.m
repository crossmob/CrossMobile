...
// crossmobile.ios.addressbook.ABNewPersonViewController implementation
...
// (ABNewPersonViewController) @property(nonatomic, readwrite) ABAddressBookRef addressBook;
...
// (ABNewPersonViewController) @property(nonatomic, readwrite) ABRecordRef displayedPerson;
...
// (ABNewPersonViewController) @property(nonatomic, assign) id< ABNewPersonViewControllerDelegate > newPersonViewDelegate ;
...
// (ABNewPersonViewController) @property(nonatomic, readwrite) ABRecordRef parentGroup;
...
// direct binding of: @property(nonatomic, assign) id< ABNewPersonViewControllerDelegate > newPersonViewDelegate ;
- (void) setNewPersonViewDelegate___crossmobile_ios_addressbook_ABNewPersonViewControllerDelegate:(id<ABNewPersonViewControllerDelegate>) newPersonViewDelegate 
{
    objc_setAssociatedObject(self, @selector(setNewPersonViewDelegate:), newPersonViewDelegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, readwrite) ABRecordRef parentGroup;
- (void) setParentGroup___crossmobile_ios_addressbook_ABRecord:(crossmobile_ios_addressbook_ABRecord*) parentGroup 
{
