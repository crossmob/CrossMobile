...
// crossmobile.ios.uikit.UIStepper implementation
...
#import "crossmobile_ios_uikit_UIStepperAppearance.h"
...
// (UIStepper) @property(nonatomic) BOOL autorepeat;
...
// (UIStepper) @property(nonatomic, getter=isContinuous) BOOL continuous;
...
// (UIStepper) @property(nonatomic) double maximumValue;
...
// (UIStepper) @property(nonatomic) double minimumValue;
...
// (UIStepper) @property(nonatomic) double stepValue;
...
// (UIStepper) @property(nonatomic) double value;
...
// (UIStepper) @property(nonatomic) BOOL wraps;
...
// (UIStepper) - (UIImage *)backgroundImageForState:(UIControlState)state;
...
// (UIStepper) - (UIImage *)decrementImageForState:(UIControlState)state;
...
// (UIStepper) - (UIImage *)dividerImageForLeftSegmentState:(UIControlState)state rightSegmentState:(UIControlState)state;
...
// (UIStepper) - (UIImage *)incrementImageForState:(UIControlState)state;
...
// (UIStepper) - (void)setBackgroundImage:(UIImage *)image forState:(UIControlState)state;
...
// (UIStepper) - (void)setDecrementImage:(UIImage *)image forState:(UIControlState)state;
...
// (UIStepper) - (void)setDividerImage:(UIImage *)image forLeftSegmentState:(UIControlState)leftState rightSegmentState:(UIControlState)rightState;
...
// (UIStepper) - (void)setIncrementImage:(UIImage *)image forState:(UIControlState)state;
...
{
    return [[crossmobile_ios_uikit_UIStepperAppearance alloc] initWithUIStepperAppearance:[UIStepper appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UIStepperAppearance alloc] initWithUIStepperAppearance:[UIStepper appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}
...
// direct binding of: @property(nonatomic) BOOL autorepeat;
- (void) setAutorepeat___boolean:(BOOL) autorepeat 
{
...
// direct binding of: @property(nonatomic) double maximumValue;
- (void) setMaximumValue___double:(double) maximumValue 
{
...
// direct binding of: @property(nonatomic) double minimumValue;
- (void) setMinimumValue___double:(double) minimumValue 
{
...
// direct binding of: @property(nonatomic) double stepValue;
- (void) setStepValue___double:(double) stepValue 
{
...
// direct binding of: @property(nonatomic) double value;
- (void) setValue___double:(double) value 
{
    [self setValue:value];
}
...
// direct binding of: @property(nonatomic) BOOL wraps;
- (void) setWraps___boolean:(BOOL) wraps 
{
    [self setWraps:wraps];
}
...
// direct binding of: - (UIImage *)decrementImageForState:(UIControlState)state;
- (UIImage*) decrementImageForState___int:(int) state 
{
...
// direct binding of: - (UIImage *)dividerImageForLeftSegmentState:(UIControlState)state rightSegmentState:(UIControlState)state;
- (UIImage*) dividerImageForLeftSegmentState___int_int:(int) state :(int) state 
{
...
// direct binding of: - (UIImage *)incrementImageForState:(UIControlState)state;
- (UIImage*) incrementImageForState___int:(int) state 
{
...
// direct binding of: - (void)setDecrementImage:(UIImage *)image forState:(UIControlState)state;
- (void) setDecrementImage___crossmobile_ios_uikit_UIImage_int:(UIImage*) image :(int) state 
{
    [self setDecrementImage:(image == JAVA_NULL ? nil : image) forState:state];
}

// direct binding of: - (void)setDividerImage:(UIImage *)image forLeftSegmentState:(UIControlState)leftState rightSegmentState:(UIControlState)rightState;
- (void) setDividerImage___crossmobile_ios_uikit_UIImage_int_int:(UIImage*) image :(int) leftState :(int) rightState 
{
    [self setDividerImage:(image == JAVA_NULL ? nil : image) forLeftSegmentState:leftState rightSegmentState:rightState];
}

// direct binding of: - (void)setIncrementImage:(UIImage *)image forState:(UIControlState)state;
- (void) setIncrementImage___crossmobile_ios_uikit_UIImage_int:(UIImage*) image :(int) state 
{
