...
// crossmobile.ios.uikit.UISwitch implementation
...
#import "crossmobile_ios_uikit_UISwitchAppearance.h"
...
// (UISwitch) @property(nonatomic, getter=isOn) BOOL on;
...
// (UISwitch) @property(nonatomic, strong) UIColor *onTintColor;
...
// (UISwitch) @property(nonatomic, strong) UIColor *thumbTintColor;
...
// (UISwitch) - (void)setOn:(BOOL)on animated:(BOOL)animated;
...
{
    return [[crossmobile_ios_uikit_UISwitchAppearance alloc] initWithUISwitchAppearance:[UISwitch appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UISwitchAppearance alloc] initWithUISwitchAppearance:[UISwitch appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}
...
// direct binding of: @property(nonatomic, getter=isOn) BOOL on;
- (void) setOn___boolean:(BOOL) on 
{
    [self setOn:on];
}
...
// direct binding of: @property(nonatomic, strong) UIColor *onTintColor;
- (void) setOnTintColor___crossmobile_ios_uikit_UIColor:(UIColor*) onTintColor 
{
...
// direct binding of: - (void)setOn:(BOOL)on animated:(BOOL)animated;
- (void) setOn___boolean_boolean:(BOOL) on :(BOOL) animated 
{
