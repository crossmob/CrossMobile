...
// crossmobile.ios.uikit.UITextField implementation
...
// (UITextField) @property(nonatomic) BOOL adjustsFontSizeToFitWidth;
...
// (UITextField) @property(nonatomic) UITextAutocapitalizationType autocapitalizationType;
...
// (UITextField) @property(nonatomic) UITextAutocorrectionType autocorrectionType;
...
// (UITextField) @property(nonatomic) UITextBorderStyle borderStyle;
...
// (UITextField) @property(nonatomic, weak) id<UITextFieldDelegate> delegate;
...
// (UITextField) @property(nonatomic) BOOL enablesReturnKeyAutomatically;
...
// (UITextField) @property(nonatomic, strong) UIFont *font;
...
// (UITextField) @property(nonatomic) UIKeyboardAppearance keyboardAppearance;
...
// (UITextField) @property(nonatomic) UIKeyboardType keyboardType;
...
// (UITextField) @property(nonatomic, copy) NSString *placeholder;
...
// (UITextField) @property(nonatomic) UIReturnKeyType returnKeyType;
...
// (UITextField) @property(nonatomic,getter=isSecureTextEntry) BOOL secureTextEntry;
...
// (UITextField) @property(nonatomic, copy) NSString *text;
...
// (UITextField) @property(nonatomic) NSTextAlignment textAlignment;
...
// (UITextField) @property(nonatomic, strong) UIColor *textColor;
...
// (UITextField) @property(nonatomic,copy) UITextContentType textContentType;
...
// direct binding of: @property(nonatomic) UITextBorderStyle borderStyle;
- (void) setBorderStyle___int:(int) borderStyle 
{
...
// direct binding of: @property(nonatomic, weak) id<UITextFieldDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UITextFieldDelegate:(id<UITextFieldDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic,copy) UITextContentType textContentType;
- (void) setTextContentType___java_lang_String:(NSString*) textContentType 
{
