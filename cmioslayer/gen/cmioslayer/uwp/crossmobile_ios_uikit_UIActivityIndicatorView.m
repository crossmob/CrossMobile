...
// crossmobile.ios.uikit.UIActivityIndicatorView implementation
...
// (UIActivityIndicatorView) @property(nonatomic) UIActivityIndicatorViewStyle activityIndicatorViewStyle ;
...
// (UIActivityIndicatorView) @property(nonatomic) BOOL hidesWhenStopped ;
...
// (UIActivityIndicatorView) - (void)stopAnimating;
...
// direct binding of: - (instancetype)initWithActivityIndicatorStyle:(UIActivityIndicatorViewStyle)style;
...
// direct binding of: @property(nonatomic) UIActivityIndicatorViewStyle activityIndicatorViewStyle ;
- (void) setActivityIndicatorViewStyle___int:(int) activityIndicatorViewStyle 
{
