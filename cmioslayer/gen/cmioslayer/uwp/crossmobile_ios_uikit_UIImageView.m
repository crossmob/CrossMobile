...
// crossmobile.ios.uikit.UIImageView implementation
...
// (UIImageView) @property(nonatomic, copy) NSArray<UIImage *> *animationImages;
...
// (UIImageView) @property(nonatomic, getter=isHighlighted) BOOL highlighted;
...
// (UIImageView) @property(nonatomic, copy) NSArray<UIImage *> *highlightedAnimationImages;
...
// (UIImageView) @property(nonatomic, strong) UIImage *highlightedImage;
...
// (UIImageView) @property(nonatomic, strong) UIImage *image;
...
// (UIImageView) - (void)startAnimating;
- (void) startAnimating__
{
    [super startAnimating];
}

// (UIImageView) - (void)stopAnimating;
...
// direct binding of: @property(nonatomic, copy) NSArray<UIImage *> *animationImages;
- (void) setAnimationImages___java_util_List:(NSArray*) animationImages 
{
...
// direct binding of: @property(nonatomic, copy) NSArray<UIImage *> *highlightedAnimationImages;
- (void) setHighlightedAnimationImages___java_util_List:(NSArray*) highlightedAnimationImages 
{
...
// direct binding of: @property(nonatomic, strong) UIImage *highlightedImage;
- (void) setHighlightedImage___crossmobile_ios_uikit_UIImage:(UIImage*) highlightedImage 
{
...
// direct binding of: - (BOOL)isAnimating;
- (BOOL) isAnimating__
{
    return [self isAnimating];
}

// direct binding of: - (void)startAnimating;
- (void) startAnimating__
{
    [self startAnimating];
}

// direct binding of: - (void)stopAnimating;
- (void) stopAnimating__
{
    [self stopAnimating];
}
