...
// crossmobile.ios.uikit.UISegmentedControlAppearance implementation

#import "crossmobile_ios_uikit_UIColor.h"
#import "crossmobile_ios_uikit_UISegmentedControlAppearance.h"

@implementation crossmobile_ios_uikit_UISegmentedControlAppearance
...
- (instancetype) initWithUISegmentedControlAppearance:(id) reference
{
    self = [super init];
