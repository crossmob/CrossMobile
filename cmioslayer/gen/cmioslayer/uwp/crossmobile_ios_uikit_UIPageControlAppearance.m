...
// crossmobile.ios.uikit.UIPageControlAppearance implementation

#import "crossmobile_ios_uikit_UIColor.h"
#import "crossmobile_ios_uikit_UIPageControlAppearance.h"

@implementation crossmobile_ios_uikit_UIPageControlAppearance
...
- (instancetype) initWithUIPageControlAppearance:(id) reference
{
    self = [super init];
