...
// crossmobile.ios.uikit.UITabBar implementation
...
// (UITabBar) @property(nonatomic, strong) UIImage *backgroundImage;
...
// (UITabBar) @property(nonatomic) UIBarStyle barStyle;
...
// (UITabBar) @property(nonatomic, strong) UIColor *barTintColor;
...
// (UITabBar) @property(nonatomic, weak) id<UITabBarDelegate> delegate;
...
// (UITabBar) @property(nonatomic) UITabBarItemPositioning itemPositioning;
...
// (UITabBar) @property(nonatomic) CGFloat itemSpacing;
...
// (UITabBar) @property(nonatomic) CGFloat itemWidth;
...
// (UITabBar) @property(nonatomic, copy) NSArray<UITabBarItem *> *items;
...
// (UITabBar) @property(nonatomic, strong) UIColor *selectedImageTintColor;
...
// (UITabBar) @property(nonatomic, weak) UITabBarItem *selectedItem;
...
// (UITabBar) @property(nonatomic, strong) UIImage *selectionIndicatorImage;
...
// (UITabBar) @property(nonatomic, strong) UIImage *shadowImage;
...
// (UITabBar) @property(nonatomic, getter=isTranslucent) BOOL translucent;
...
// (UITabBar) - (void)beginCustomizingItems:(NSArray<UITabBarItem *> *)items;
...
// (UITabBar) - (BOOL)endCustomizingAnimated:(BOOL)animated;
...
// (UITabBar) - (void)setItems:(NSArray<UITabBarItem *> *)items animated:(BOOL)animated;
...
// direct binding of: @property(nonatomic, strong) UIImage *backgroundImage;
- (void) setBackgroundImage___crossmobile_ios_uikit_UIImage:(UIImage*) backgroundImage 
{
...
// direct binding of: @property(nonatomic) UIBarStyle barStyle;
- (void) setBarStyle___int:(int) barStyle 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *barTintColor;
- (void) setBarTintColor___crossmobile_ios_uikit_UIColor:(UIColor*) barTintColor 
{
...
// direct binding of: @property(nonatomic, weak) id<UITabBarDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UITabBarDelegate:(id<UITabBarDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic) UITabBarItemPositioning itemPositioning;
- (void) setItemPositioning___int:(int) itemPositioning 
{
...
// direct binding of: @property(nonatomic) CGFloat itemSpacing;
- (void) setItemSpacing___double:(double) itemSpacing 
{
...
// direct binding of: @property(nonatomic) CGFloat itemWidth;
- (void) setItemWidth___double:(double) itemWidth 
{
...
// direct binding of: @property(nonatomic, copy) NSArray<UITabBarItem *> *items;
- (void) setItems___java_util_List:(NSArray*) items 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *selectedImageTintColor;
- (void) setSelectedImageTintColor___crossmobile_ios_uikit_UIColor:(UIColor*) selectedImageTintColor 
{
...
// direct binding of: @property(nonatomic, weak) UITabBarItem *selectedItem;
- (void) setSelectedItem___crossmobile_ios_uikit_UITabBarItem:(UITabBarItem*) selectedItem 
{
    objc_setAssociatedObject(self, @selector(setSelectedItem:), selectedItem, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, strong) UIImage *selectionIndicatorImage;
- (void) setSelectionIndicatorImage___crossmobile_ios_uikit_UIImage:(UIImage*) selectionIndicatorImage 
{
...
// direct binding of: @property(nonatomic, strong) UIImage *shadowImage;
- (void) setShadowImage___crossmobile_ios_uikit_UIImage:(UIImage*) shadowImage 
{
...
// direct binding of: @property(nonatomic, getter=isTranslucent) BOOL translucent;
- (void) setTranslucent___boolean:(BOOL) translucent 
{
...
// direct binding of: - (void)beginCustomizingItems:(NSArray<UITabBarItem *> *)items;
- (void) beginCustomizingItems___java_util_List:(NSArray*) items 
{
    [self beginCustomizingItems:(items == JAVA_NULL ? nil : items)];
}

// direct binding of: - (BOOL)endCustomizingAnimated:(BOOL)animated;
- (BOOL) endCustomizingAnimated___boolean:(BOOL) animated 
{
    return [self endCustomizingAnimated:animated];
}

// direct binding of: - (BOOL)isCustomizing;
- (BOOL) isCustomizing__
{
    return [self isCustomizing];
}

// direct binding of: - (void)setItems:(NSArray<UITabBarItem *> *)items animated:(BOOL)animated;
- (void) setItems___java_util_List_boolean:(NSArray*) items :(BOOL) animated 
{
