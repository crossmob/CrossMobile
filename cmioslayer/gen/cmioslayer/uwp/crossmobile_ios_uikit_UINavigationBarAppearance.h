...
// crossmobile.ios.uikit.UINavigationBarAppearance definition
...
@interface crossmobile_ios_uikit_UINavigationBarAppearance : crossmobile_ios_foundation_NSObject {
@public id $reference;
}
