...
// crossmobile.ios.uikit.UISearchBar implementation
...
// (UISearchBar) @property(nonatomic) UITextAutocapitalizationType autocapitalizationType ;
...
// (UISearchBar) @property(nonatomic) UITextAutocorrectionType autocorrectionType ;
...
// (UISearchBar) @property(nonatomic) UIBarStyle barStyle;
...
// (UISearchBar) @property(nonatomic, strong) UIColor *barTintColor;
...
// (UISearchBar) @property(nonatomic, weak) id<UISearchBarDelegate> delegate;
...
// (UISearchBar) @property(nonatomic) UIKeyboardType keyboardType ;
...
// (UISearchBar) @property(nonatomic, copy) NSString *placeholder;
...
// (UISearchBar) @property(nonatomic, copy) NSString *prompt;
...
// (UISearchBar) @property(nonatomic, copy) NSArray<NSString *> *scopeButtonTitles;
...
// (UISearchBar) @property(nonatomic) UISearchBarStyle searchBarStyle;
...
// (UISearchBar) @property(nonatomic) NSInteger selectedScopeButtonIndex;
...
// (UISearchBar) @property(nonatomic) BOOL showsBookmarkButton;
...
// (UISearchBar) @property(nonatomic) BOOL showsCancelButton;
...
// (UISearchBar) @property(nonatomic) BOOL showsScopeBar;
...
// (UISearchBar) @property(nonatomic, copy) NSString *text;
...
// (UISearchBar) @property(nonatomic, assign, getter=isTranslucent) BOOL translucent;
...
// (UISearchBar) - (void)setImage:(UIImage *)iconImage forSearchBarIcon:(UISearchBarIcon)icon state:(UIControlState)state;
...
// direct binding of: @property(nonatomic, weak) id<UISearchBarDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UISearchBarDelegate:(id<UISearchBarDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, copy) NSString *placeholder;
- (void) setPlaceholder___java_lang_String:(NSString*) placeholder 
{
...
// direct binding of: @property(nonatomic, copy) NSArray<NSString *> *scopeButtonTitles;
- (void) setScopeButtonTitles___java_util_List:(NSArray*) scopeButtonTitles 
{
...
// direct binding of: @property(nonatomic) UISearchBarStyle searchBarStyle;
- (void) setSearchBarStyle___int:(int) searchBarStyle 
{
...
// direct binding of: @property(nonatomic) NSInteger selectedScopeButtonIndex;
- (void) setSelectedScopeButtonIndex___int:(int) selectedScopeButtonIndex 
{
...
// direct binding of: @property(nonatomic) BOOL showsBookmarkButton;
- (void) setShowsBookmarkButton___boolean:(BOOL) showsBookmarkButton 
{
...
// direct binding of: @property(nonatomic) BOOL showsCancelButton;
- (void) setShowsCancelButton___boolean:(BOOL) showsCancelButton 
{
...
// direct binding of: @property(nonatomic) BOOL showsScopeBar;
- (void) setShowsScopeBar___boolean:(BOOL) showsScopeBar 
{
...
// direct binding of: @property(nonatomic, assign, getter=isTranslucent) BOOL translucent;
- (void) setTranslucent___boolean:(BOOL) translucent 
{
...
// direct binding of: - (void)setImage:(UIImage *)iconImage forSearchBarIcon:(UISearchBarIcon)icon state:(UIControlState)state;
- (void) setImage___crossmobile_ios_uikit_UIImage_int_int:(UIImage*) iconImage :(int) icon :(int) state 
{
