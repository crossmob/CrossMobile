...
// crossmobile.ios.uikit.UIPickerView implementation
...
// (UIPickerView) @property(nonatomic, weak) id<UIPickerViewDataSource> dataSource;
...
// (UIPickerView) @property(nonatomic, weak) id<UIPickerViewDelegate> delegate;
...
// (UIPickerView) @property(nonatomic, readonly) NSInteger numberOfComponents;
...
// (UIPickerView) @property(nonatomic) BOOL showsSelectionIndicator;
...
// (UIPickerView) - (NSInteger)numberOfRowsInComponent:(NSInteger)component;
...
// (UIPickerView) - (void)reloadAllComponents;
- (void) reloadAllComponents__
{
    [super reloadAllComponents];
}

// (UIPickerView) - (void)reloadComponent:(NSInteger)component;
...
// (UIPickerView) - (CGSize)rowSizeForComponent:(NSInteger)component;
...
// (UIPickerView) - (void)selectRow:(NSInteger)row inComponent:(NSInteger)component animated:(BOOL)animated;
...
// (UIPickerView) - (NSInteger)selectedRowInComponent:(NSInteger)component;
...
// (UIPickerView) - (UIView *)viewForRow:(NSInteger)row forComponent:(NSInteger)component;
...
// direct binding of: @property(nonatomic, weak) id<UIPickerViewDataSource> dataSource;
- (void) setDataSource___crossmobile_ios_uikit_UIPickerViewDataSource:(id<UIPickerViewDataSource>) dataSource 
{
    objc_setAssociatedObject(self, @selector(setDataSource:), dataSource, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, weak) id<UIPickerViewDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UIPickerViewDelegate:(id<UIPickerViewDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, readonly) NSInteger numberOfComponents;
- (int) numberOfComponents__
{
    return [self numberOfComponents];
}

// direct binding of: @property(nonatomic) BOOL showsSelectionIndicator;
- (void) setShowsSelectionIndicator___boolean:(BOOL) showsSelectionIndicator 
{
...
// direct binding of: - (NSInteger)numberOfRowsInComponent:(NSInteger)component;
- (int) numberOfRowsInComponent___int:(int) component 
{
    return [self numberOfRowsInComponent:component];
}

// direct binding of: - (void)reloadAllComponents;
- (void) reloadAllComponents__
{
    [self reloadAllComponents];
}

// direct binding of: - (void)reloadComponent:(NSInteger)component;
- (void) reloadComponent___int:(int) component 
{
    [self reloadComponent:component];
}

// direct binding of: - (CGSize)rowSizeForComponent:(NSInteger)component;
- (crossmobile_ios_coregraphics_CGSize*) rowSizeForComponent___int:(int) component 
{
    return [[crossmobile_ios_coregraphics_CGSize alloc] initWithCGSize:[self rowSizeForComponent:component]];
}

// direct binding of: - (void)selectRow:(NSInteger)row inComponent:(NSInteger)component animated:(BOOL)animated;
- (void) selectRow___int_int_boolean:(int) row :(int) component :(BOOL) animated 
{
    [self selectRow:row inComponent:component animated:animated];
}

// direct binding of: - (NSInteger)selectedRowInComponent:(NSInteger)component;
- (int) selectedRowInComponent___int:(int) component 
{
    return [self selectedRowInComponent:component];
}

// direct binding of: - (UIView *)viewForRow:(NSInteger)row forComponent:(NSInteger)component;
- (UIView*) viewForRow___int_int:(int) row :(int) component 
{
