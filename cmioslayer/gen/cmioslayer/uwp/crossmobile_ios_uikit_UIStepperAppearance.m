...
// crossmobile.ios.uikit.UIStepperAppearance implementation

#import "crossmobile_ios_uikit_UIColor.h"
#import "crossmobile_ios_uikit_UIStepperAppearance.h"

@implementation crossmobile_ios_uikit_UIStepperAppearance
...
- (instancetype) initWithUIStepperAppearance:(id) reference
{
    self = [super init];
