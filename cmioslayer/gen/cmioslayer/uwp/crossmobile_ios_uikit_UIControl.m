...
// crossmobile.ios.uikit.UIControl implementation
...
// direct binding of: @property(nonatomic, readonly) NSSet *allTargets;
- (NSSet*) allTargets__
{
...
// direct binding of: @property(nonatomic) UIControlContentHorizontalAlignment contentHorizontalAlignment;
- (void) setContentHorizontalAlignment___int:(int) contentHorizontalAlignment 
{
...
// direct binding of: @property(nonatomic) UIControlContentVerticalAlignment contentVerticalAlignment;
- (void) setContentVerticalAlignment___int:(int) contentVerticalAlignment 
{
...
// direct binding of: @property(nonatomic, readonly) UIControlState state;
- (int) state__
{
    return [self state];
}

// direct binding of: - (void)addTarget:(id)target action:(SEL)action forControlEvents:(UIControlEvents)controlEvents;
- (void) addTarget___crossmobile_ios_uikit_UIControlDelegate_int:(id<crossmobile_ios_uikit_UIControlDelegate>) target :(int) controlEvents 
{
    if (target == JAVA_NULL)
        return;
...
// direct binding of: - (void)removeTarget:(id)target action:(SEL)action forControlEvents:(UIControlEvents)controlEvents;
- (void) removeTarget___crossmobile_ios_uikit_UIControlDelegate_int:(id<crossmobile_ios_uikit_UIControlDelegate>) target :(int) controlEvents 
{
    if (target == JAVA_NULL)
        return;
...
// direct binding of: - (void)sendActionsForControlEvents:(UIControlEvents)controlEvents;
- (void) sendActionsForControlEvents___int:(int) controlEvents 
{
