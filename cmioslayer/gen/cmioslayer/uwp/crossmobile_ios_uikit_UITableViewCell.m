...
// crossmobile.ios.uikit.UITableViewCell implementation
...
// (UITableViewCell) @property(nonatomic, strong) UIView *backgroundView;
...
// (UITableViewCell) @property(nonatomic, readonly, strong) UIView *contentView;
...
// (UITableViewCell) @property(nonatomic, readonly, strong) UILabel *detailTextLabel;
...
// (UITableViewCell) @property(nonatomic, readonly) UITableViewCellEditingStyle editingStyle;
- (int) editingStyle__
{
...
// (UITableViewCell) @property(nonatomic, getter=isHighlighted) BOOL highlighted;
...
// (UITableViewCell) @property(nonatomic, readonly, strong) UIImageView *imageView;
...
// (UITableViewCell) @property(nonatomic, readonly, copy) NSString *reuseIdentifier;
...
// (UITableViewCell) @property(nonatomic, getter=isSelected) BOOL selected;
...
// (UITableViewCell) @property(nonatomic, strong) UIView *selectedBackgroundView;
...
// (UITableViewCell) @property(nonatomic) UITableViewCellSelectionStyle selectionStyle;
...
// (UITableViewCell) @property(nonatomic, readonly, strong) UILabel *textLabel;
- (UILabel*) textLabel__
{
...
// direct binding of: @property(nonatomic, strong) UIView *backgroundView;
- (void) setBackgroundView___crossmobile_ios_uikit_UIView:(UIView*) backgroundView 
{
...
// direct binding of: @property(nonatomic, readonly, strong) UIView *contentView;
- (UIView*) contentView__
{
...
// direct binding of: @property(nonatomic, readonly, strong) UILabel *detailTextLabel;
- (UILabel*) detailTextLabel__
{
...
// direct binding of: @property(nonatomic, readonly) UITableViewCellEditingStyle editingStyle;
- (int) editingStyle__
{
    return [self editingStyle];
}

// direct binding of: @property(nonatomic, getter=isHighlighted) BOOL highlighted;
- (void) setHighlighted___boolean:(BOOL) highlighted 
{
...
// direct binding of: @property(nonatomic, readonly, copy) NSString *reuseIdentifier;
- (NSString*) reuseIdentifier__
{
...
// direct binding of: @property(nonatomic, getter=isSelected) BOOL selected;
- (void) setSelected___boolean:(BOOL) selected 
{
...
// direct binding of: @property(nonatomic, strong) UIView *selectedBackgroundView;
- (void) setSelectedBackgroundView___crossmobile_ios_uikit_UIView:(UIView*) selectedBackgroundView 
{
...
// direct binding of: @property(nonatomic) UITableViewCellSelectionStyle selectionStyle;
- (void) setSelectionStyle___int:(int) selectionStyle 
{
...
// direct binding of: @property(nonatomic, readonly, strong) UILabel *textLabel;
- (UILabel*) textLabel__
{
