...
// crossmobile.ios.uikit.UISwitchAppearance implementation

#import "crossmobile_ios_uikit_UIColor.h"
#import "crossmobile_ios_uikit_UISwitchAppearance.h"

@implementation crossmobile_ios_uikit_UISwitchAppearance
...
- (instancetype) initWithUISwitchAppearance:(id) reference
{
    self = [super init];
