...
// crossmobile.ios.uikit.UIActionSheet implementation
...
// (UIActionSheet) @property(nonatomic) NSInteger cancelButtonIndex;
...
// (UIActionSheet) @property(nonatomic, weak) id<UIActionSheetDelegate> delegate;
...
// (UIActionSheet) @property(nonatomic) NSInteger destructiveButtonIndex;
- (int) destructiveButtonIndex__
{
    return [super destructiveButtonIndex];
}

// (UIActionSheet) @property(nonatomic, readonly) NSInteger firstOtherButtonIndex;
...
// (UIActionSheet) @property(nonatomic, readonly) NSInteger numberOfButtons;
...
// (UIActionSheet) @property(nonatomic, copy) NSString *title;
...
// (UIActionSheet) - (NSInteger)addButtonWithTitle:(NSString *)title;
...
// (UIActionSheet) - (void)dismissWithClickedButtonIndex:(NSInteger)buttonIndex animated:(BOOL)animated;
...
- (instancetype) __init_crossmobile_ios_uikit_UIActionSheet___java_lang_String_crossmobile_ios_uikit_UIActionSheetDelegate_java_lang_String_java_lang_String_java_lang_String_ARRAYTYPE:(NSString*) title :(id<UIActionSheetDelegate>) delegate :(NSString*) cancelButtonTitle :(NSString*) destructiveButtonTitle :(XMLVMArray*) otherButtonTitles 
{
    ...
    return [self initWithTitle:(title == JAVA_NULL ? nil : title) delegate:(delegate == JAVA_NULL ? nil : delegate) cancelButtonTitle:(cancelButtonTitle == JAVA_NULL ? nil : cancelButtonTitle) destructiveButtonTitle:(destructiveButtonTitle == JAVA_NULL ? nil : destructiveButtonTitle) otherButtonTitles:
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 0 ? [otherButtonTitles objectAtIndex:0] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 1 ? [otherButtonTitles objectAtIndex:1] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 2 ? [otherButtonTitles objectAtIndex:2] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 3 ? [otherButtonTitles objectAtIndex:3] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 4 ? [otherButtonTitles objectAtIndex:4] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 5 ? [otherButtonTitles objectAtIndex:5] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 6 ? [otherButtonTitles objectAtIndex:6] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 7 ? [otherButtonTitles objectAtIndex:7] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 8 ? [otherButtonTitles objectAtIndex:8] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 9 ? [otherButtonTitles objectAtIndex:9] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 10 ? [otherButtonTitles objectAtIndex:10] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 11 ? [otherButtonTitles objectAtIndex:11] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 12 ? [otherButtonTitles objectAtIndex:12] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 13 ? [otherButtonTitles objectAtIndex:13] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 14 ? [otherButtonTitles objectAtIndex:14] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 15 ? [otherButtonTitles objectAtIndex:15] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 16 ? [otherButtonTitles objectAtIndex:16] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 17 ? [otherButtonTitles objectAtIndex:17] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 18 ? [otherButtonTitles objectAtIndex:18] : nil),
        (otherButtonTitles != JAVA_NULL && otherButtonTitles->length > 19 ? [otherButtonTitles objectAtIndex:19] : nil),
        nil];
}

// direct binding of: @property(nonatomic) NSInteger cancelButtonIndex;
- (int) cancelButtonIndex__
{
    return [self cancelButtonIndex];
}

// direct binding of: @property(nonatomic, weak) id<UIActionSheetDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UIActionSheetDelegate:(id<UIActionSheetDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic) NSInteger destructiveButtonIndex;
- (int) destructiveButtonIndex__
{
    return [self destructiveButtonIndex];
}

// direct binding of: @property(nonatomic, readonly) NSInteger firstOtherButtonIndex;
- (int) firstOtherButtonIndex__
{
    return [self firstOtherButtonIndex];
}

// direct binding of: @property(nonatomic, readonly) NSInteger numberOfButtons;
- (int) numberOfButtons__
{
...
// direct binding of: - (NSInteger)addButtonWithTitle:(NSString *)title;
- (int) addButtonWithTitle___java_lang_String:(NSString*) title 
{
    return [self addButtonWithTitle:(title == JAVA_NULL ? nil : title)];
}

// direct binding of: - (void)dismissWithClickedButtonIndex:(NSInteger)buttonIndex animated:(BOOL)animated;
- (void) dismissWithClickedButtonIndex___int_boolean:(int) buttonIndex :(BOOL) animated 
{
    [self dismissWithClickedButtonIndex:buttonIndex animated:animated];
}

// direct binding of: - (void)showFromTabBar:(UITabBar *)view;
- (void) showFromTabBar___crossmobile_ios_uikit_UITabBar:(UITabBar*) view 
{
    [self showFromTabBar:(view == JAVA_NULL ? nil : view)];
}

// direct binding of: - (void)showFromToolbar:(UIToolbar *)view;
- (void) showFromToolbar___crossmobile_ios_uikit_UIToolbar:(UIToolbar*) view 
{
    [self showFromToolbar:(view == JAVA_NULL ? nil : view)];
}

// direct binding of: - (void)showInView:(UIView *)view;
- (void) showInView___crossmobile_ios_uikit_UIView:(UIView*) view 
{
