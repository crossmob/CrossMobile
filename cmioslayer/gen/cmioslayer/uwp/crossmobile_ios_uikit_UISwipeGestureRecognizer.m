...
// crossmobile.ios.uikit.UISwipeGestureRecognizer implementation
...
// (UISwipeGestureRecognizer) @property(nonatomic) UISwipeGestureRecognizerDirection direction;
...
// (UISwipeGestureRecognizer) @property(nonatomic) NSUInteger numberOfTouchesRequired;
...
// direct binding of: @property(nonatomic) UISwipeGestureRecognizerDirection direction;
- (void) setDirection___int:(int) direction 
{
