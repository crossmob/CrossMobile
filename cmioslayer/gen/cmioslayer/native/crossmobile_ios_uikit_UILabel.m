...
// crossmobile.ios.uikit.UILabel implementation
...
// (UILabel) @property(nonatomic) UIBaselineAdjustment baselineAdjustment;
...
// (UILabel) @property(nonatomic, strong) UIFont *font;
...
// (UILabel) @property(nonatomic, getter=isHighlighted) BOOL highlighted;
...
// (UILabel) @property(nonatomic, strong) UIColor *highlightedTextColor;
...
// (UILabel) @property(nonatomic) NSLineBreakMode lineBreakMode;
...
// (UILabel) @property(nonatomic) CGFloat minimumScaleFactor;
...
// (UILabel) @property(nonatomic) NSInteger numberOfLines;
...
// (UILabel) @property(nonatomic) CGFloat preferredMaxLayoutWidth;
...
// (UILabel) @property(nonatomic, strong) UIColor *shadowColor;
...
// (UILabel) @property(nonatomic) CGSize shadowOffset;
...
// (UILabel) @property(nonatomic, copy) NSString *text;
...
// (UILabel) @property(nonatomic) NSTextAlignment textAlignment;
...
// (UILabel) @property(nonatomic, strong) UIColor *textColor;
...
// direct binding of: @property(nonatomic) BOOL adjustsFontSizeToFitWidth;
- (void) setAdjustsFontSizeToFitWidth___boolean:(BOOL) adjustsFontSizeToFitWidth 
{
...
// direct binding of: @property(nonatomic) UIBaselineAdjustment baselineAdjustment;
- (void) setBaselineAdjustment___int:(int) baselineAdjustment 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *highlightedTextColor;
- (void) setHighlightedTextColor___crossmobile_ios_uikit_UIColor:(UIColor*) highlightedTextColor 
{
...
// direct binding of: @property(nonatomic) NSLineBreakMode lineBreakMode;
- (void) setLineBreakMode___int:(int) lineBreakMode 
{
...
// direct binding of: @property(nonatomic) CGFloat minimumScaleFactor;
- (void) setMinimumScaleFactor___double:(double) minimumScaleFactor 
{
...
// direct binding of: @property(nonatomic) NSInteger numberOfLines;
- (void) setNumberOfLines___int:(int) numberOfLines 
{
...
// direct binding of: @property(nonatomic) CGFloat preferredMaxLayoutWidth;
- (void) setPreferredMaxLayoutWidth___double:(double) preferredMaxLayoutWidth 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *shadowColor;
- (void) setShadowColor___crossmobile_ios_uikit_UIColor:(UIColor*) shadowColor 
{
...
// direct binding of: @property(nonatomic) CGSize shadowOffset;
- (void) setShadowOffset___crossmobile_ios_coregraphics_CGSize:(crossmobile_ios_coregraphics_CGSize*) shadowOffset 
{
