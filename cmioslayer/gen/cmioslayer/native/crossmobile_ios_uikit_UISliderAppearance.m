...
// crossmobile.ios.uikit.UISliderAppearance implementation

#import "crossmobile_ios_uikit_UIColor.h"
#import "crossmobile_ios_uikit_UISliderAppearance.h"

@implementation crossmobile_ios_uikit_UISliderAppearance
...
- (instancetype) initWithUISliderAppearance:(id) reference
{
    self = [super init];
