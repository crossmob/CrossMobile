...
// crossmobile.ios.uikit.UIActivityViewController implementation
...
// (UIActivityViewController) @property(nonatomic, copy) NSArray<UIActivityType> *excludedActivityTypes;
...
// direct binding of: - (instancetype)initWithActivityItems:(NSArray *)activityItems applicationActivities:(NSArray<__kindof UIActivity *> *)applicationActivities;
...
// direct binding of: @property(nonatomic, copy) UIActivityViewControllerCompletionHandler completionHandler;
...
// direct binding of: @property(nonatomic, copy) UIActivityViewControllerCompletionWithItemsHandler completionWithItemsHandler;
...
// direct binding of: @property(nonatomic, copy) NSArray<UIActivityType> *excludedActivityTypes;
- (void) setExcludedActivityTypes___java_util_List:(NSArray*) excludedActivityTypes 
{
