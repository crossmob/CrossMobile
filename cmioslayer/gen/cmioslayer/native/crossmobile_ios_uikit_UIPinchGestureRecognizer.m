...
// crossmobile.ios.uikit.UIPinchGestureRecognizer implementation
...
// (UIPinchGestureRecognizer) @property(nonatomic) CGFloat scale;
...
// (UIPinchGestureRecognizer) @property(nonatomic, readonly) CGFloat velocity;
- (double) velocity__
{
...
// direct binding of: @property(nonatomic) CGFloat scale;
- (void) setScale___double:(double) scale 
{
    [self setScale:scale];
}
