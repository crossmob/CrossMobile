...
// crossmobile.ios.uikit.UIAlertController implementation
...
// (UIAlertController) @property(nonatomic, readonly) NSArray<UIAlertAction *> *actions;
- (NSArray*) actions__
{
...
// (UIAlertController) @property(nonatomic, copy) NSString *message;
...
// (UIAlertController) @property(nonatomic, readonly) UIAlertControllerStyle preferredStyle;
...
// (UIAlertController) @property(nonatomic, readonly) NSArray<UITextField *> *textFields;
...
// (UIAlertController) - (void)addAction:(UIAlertAction *)action;
...
// direct binding of: + (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(UIAlertControllerStyle)preferredStyle;
...
// direct binding of: @property(nonatomic, readonly) NSArray<UIAlertAction *> *actions;
- (NSArray*) actions__
{
...
// direct binding of: @property(nonatomic, readonly) UIAlertControllerStyle preferredStyle;
- (int) preferredStyle__
{
    return [self preferredStyle];
}

// direct binding of: @property(nonatomic, readonly) NSArray<UITextField *> *textFields;
- (NSArray*) textFields__
{
...
// direct binding of: - (void)addAction:(UIAlertAction *)action;
- (void) addAction___crossmobile_ios_uikit_UIAlertAction:(UIAlertAction*) action 
{
    [self addAction:(action == JAVA_NULL ? nil : action)];
}

// direct binding of: - (void)addTextFieldWithConfigurationHandler:(void (^)(UITextField *textField))configurationHandler;
