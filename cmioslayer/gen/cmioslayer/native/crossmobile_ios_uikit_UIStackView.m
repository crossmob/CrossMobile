...
// crossmobile.ios.uikit.UIStackView implementation
...
// (UIStackView) @property(nonatomic) UIStackViewAlignment alignment;
...
// (UIStackView) @property(nonatomic, readonly, copy) NSArray<__kindof UIView *> *arrangedSubviews;
...
// (UIStackView) @property(nonatomic) UILayoutConstraintAxis axis;
...
// (UIStackView) @property(nonatomic, getter=isBaselineRelativeArrangement) BOOL baselineRelativeArrangement;
...
// (UIStackView) @property(nonatomic) UIStackViewDistribution distribution;
...
// (UIStackView) @property(nonatomic, getter=isLayoutMarginsRelativeArrangement) BOOL layoutMarginsRelativeArrangement;
...
// (UIStackView) @property(nonatomic) CGFloat spacing;
...
// (UIStackView) - (void)addArrangedSubview:(UIView *)view;
...
// (UIStackView) - (void)insertArrangedSubview:(UIView *)view atIndex:(NSUInteger)stackIndex;
...
// (UIStackView) - (void)removeArrangedSubview:(UIView *)view;
...
{
    return [[crossmobile_ios_uikit_UIStackViewAppearance alloc] initWithUIStackViewAppearance:[UIStackView appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UIStackViewAppearance alloc] initWithUIStackViewAppearance:[UIStackView appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}

// direct binding of: - (instancetype)initWithArrangedSubviews:(NSArray<__kindof UIView *> *)views;
...
// direct binding of: @property(nonatomic) UIStackViewAlignment alignment;
- (void) setAlignment___int:(int) alignment 
{
...
// direct binding of: @property(nonatomic, readonly, copy) NSArray<__kindof UIView *> *arrangedSubviews;
- (NSArray*) arrangedSubviews__
{
...
// direct binding of: @property(nonatomic) UILayoutConstraintAxis axis;
- (void) setAxis___int:(int) axis 
{
    [self setAxis:axis];
}
...
// direct binding of: @property(nonatomic, getter=isBaselineRelativeArrangement) BOOL baselineRelativeArrangement;
- (void) setBaselineRelativeArrangement___boolean:(BOOL) baselineRelativeArrangement 
{
...
// direct binding of: @property(nonatomic) UIStackViewDistribution distribution;
- (void) setDistribution___int:(int) distribution 
{
...
// direct binding of: @property(nonatomic, getter=isLayoutMarginsRelativeArrangement) BOOL layoutMarginsRelativeArrangement;
- (void) setLayoutMarginsRelativeArrangement___boolean:(BOOL) layoutMarginsRelativeArrangement 
{
...
// direct binding of: @property(nonatomic) CGFloat spacing;
- (void) setSpacing___double:(double) spacing 
{
...
// direct binding of: - (void)addArrangedSubview:(UIView *)view;
- (void) addArrangedSubview___crossmobile_ios_uikit_UIView:(UIView*) view 
{
    [self addArrangedSubview:(view == JAVA_NULL ? nil : view)];
}

// direct binding of: - (void)insertArrangedSubview:(UIView *)view atIndex:(NSUInteger)stackIndex;
- (void) insertArrangedSubview___crossmobile_ios_uikit_UIView_int:(UIView*) view :(int) stackIndex 
{
    [self insertArrangedSubview:(view == JAVA_NULL ? nil : view) atIndex:stackIndex];
}

// direct binding of: - (void)removeArrangedSubview:(UIView *)view;
- (void) removeArrangedSubview___crossmobile_ios_uikit_UIView:(UIView*) view 
{
