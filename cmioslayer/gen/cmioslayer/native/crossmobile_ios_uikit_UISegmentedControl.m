...
// crossmobile.ios.uikit.UISegmentedControl implementation
...
#import "crossmobile_ios_uikit_UISegmentedControlAppearance.h"
...
// (UISegmentedControl) @property(nonatomic, getter=isMomentary) BOOL momentary;
...
// (UISegmentedControl) @property(nonatomic, readonly) NSUInteger numberOfSegments;
...
// (UISegmentedControl) @property(nonatomic) UISegmentedControlStyle segmentedControlStyle;
...
// (UISegmentedControl) @property(nonatomic) NSInteger selectedSegmentIndex;
...
// (UISegmentedControl) - (UIImage *)imageForSegmentAtIndex:(NSUInteger)segment;
...
// (UISegmentedControl) - (void)insertSegmentWithImage:(UIImage *)image atIndex:(NSUInteger)segment animated:(BOOL)animated;
...
// (UISegmentedControl) - (void)insertSegmentWithTitle:(NSString *)title atIndex:(NSUInteger)segment animated:(BOOL)animated;
...
// (UISegmentedControl) - (void)removeAllSegments;
...
// (UISegmentedControl) - (void)removeSegmentAtIndex:(NSUInteger)segment animated:(BOOL)animated;
...
// (UISegmentedControl) - (void)setImage:(UIImage *)image forSegmentAtIndex:(NSUInteger)segment;
...
// (UISegmentedControl) - (void)setTitle:(NSString *)title forSegmentAtIndex:(NSUInteger)segment;
...
// (UISegmentedControl) - (NSString *)titleForSegmentAtIndex:(NSUInteger)segment;
...
{
    return [[crossmobile_ios_uikit_UISegmentedControlAppearance alloc] initWithUISegmentedControlAppearance:[UISegmentedControl appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UISegmentedControlAppearance alloc] initWithUISegmentedControlAppearance:[UISegmentedControl appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}
...
// direct binding of: - (instancetype)initWithItems:(NSArray *)items;
...
// direct binding of: @property(nonatomic, getter=isMomentary) BOOL momentary;
- (void) setMomentary___boolean:(BOOL) momentary 
{
...
// direct binding of: @property(nonatomic, readonly) NSUInteger numberOfSegments;
- (int) numberOfSegments__
{
    return [self numberOfSegments];
}

// direct binding of: @property(nonatomic) UISegmentedControlStyle segmentedControlStyle;
- (void) setSegmentedControlStyle___int:(int) segmentedControlStyle 
{
...
// direct binding of: @property(nonatomic) NSInteger selectedSegmentIndex;
- (void) setSelectedSegmentIndex___int:(int) selectedSegmentIndex 
{
...
// direct binding of: - (UIImage *)imageForSegmentAtIndex:(NSUInteger)segment;
- (UIImage*) imageForSegmentAtIndex___int:(int) segment 
{
...
// direct binding of: - (void)insertSegmentWithImage:(UIImage *)image atIndex:(NSUInteger)segment animated:(BOOL)animated;
- (void) insertSegmentWithImage___crossmobile_ios_uikit_UIImage_int_boolean:(UIImage*) image :(int) segment :(BOOL) animated 
{
    [self insertSegmentWithImage:(image == JAVA_NULL ? nil : image) atIndex:segment animated:animated];
}

// direct binding of: - (void)insertSegmentWithTitle:(NSString *)title atIndex:(NSUInteger)segment animated:(BOOL)animated;
- (void) insertSegmentWithTitle___java_lang_String_int_boolean:(NSString*) title :(int) segment :(BOOL) animated 
{
    [self insertSegmentWithTitle:(title == JAVA_NULL ? nil : title) atIndex:segment animated:animated];
}

// direct binding of: - (void)removeAllSegments;
- (void) removeAllSegments__
{
    [self removeAllSegments];
}

// direct binding of: - (void)removeSegmentAtIndex:(NSUInteger)segment animated:(BOOL)animated;
- (void) removeSegmentAtIndex___int_boolean:(int) segment :(BOOL) animated 
{
    [self removeSegmentAtIndex:segment animated:animated];
}

// direct binding of: - (void)setImage:(UIImage *)image forSegmentAtIndex:(NSUInteger)segment;
- (void) setImage___crossmobile_ios_uikit_UIImage_int:(UIImage*) image :(int) segment 
{
    [self setImage:(image == JAVA_NULL ? nil : image) forSegmentAtIndex:segment];
}

// direct binding of: - (void)setTitle:(NSString *)title forSegmentAtIndex:(NSUInteger)segment;
- (void) setTitle___java_lang_String_int:(NSString*) title :(int) segment 
{
    [self setTitle:(title == JAVA_NULL ? nil : title) forSegmentAtIndex:segment];
}

// direct binding of: - (NSString *)titleForSegmentAtIndex:(NSUInteger)segment;
- (NSString*) titleForSegmentAtIndex___int:(int) segment 
{
