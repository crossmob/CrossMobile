...
#import "crossmobile_ios_uikit_UISliderAppearance.h"
...
{
    return [[crossmobile_ios_uikit_UISliderAppearance alloc] initWithUISliderAppearance:[UISlider appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UISliderAppearance alloc] initWithUISliderAppearance:[UISlider appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}
