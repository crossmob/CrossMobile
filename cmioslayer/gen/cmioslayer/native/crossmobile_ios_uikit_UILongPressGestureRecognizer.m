...
// crossmobile.ios.uikit.UILongPressGestureRecognizer implementation
...
// (UILongPressGestureRecognizer) @property(nonatomic) CGFloat allowableMovement;
...
// (UILongPressGestureRecognizer) @property(nonatomic) NSUInteger numberOfTapsRequired;
...
// (UILongPressGestureRecognizer) @property(nonatomic) NSUInteger numberOfTouchesRequired;
...
// direct binding of: @property(nonatomic) CGFloat allowableMovement;
- (void) setAllowableMovement___double:(double) allowableMovement 
{
...
// direct binding of: @property(nonatomic) CFTimeInterval minimumPressDuration;
- (void) setMinimumPressDuration___double:(double) minimumPressDuration 
{
