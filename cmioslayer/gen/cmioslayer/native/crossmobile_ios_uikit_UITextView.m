...
{
    return [[crossmobile_ios_uikit_UITextViewAppearance alloc] initWithUITextViewAppearance:[UITextView appearance]];
}
...
{
    return [[crossmobile_ios_uikit_UITextViewAppearance alloc] initWithUITextViewAppearance:[UITextView appearanceWhenContainedInInstancesOfClasses:jclass_to_class_list(containerTypes == JAVA_NULL ? nil : containerTypes)]];
}
