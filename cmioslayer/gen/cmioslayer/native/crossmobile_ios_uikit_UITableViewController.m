...
// crossmobile.ios.uikit.UITableViewController implementation
...
// (UITableViewController) @property(nonatomic, strong) UITableView *tableView;
...
// (UITableViewController) - (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
...
// (UITableViewController) - (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath;
...
// (UITableViewController) - (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section;
...
// (UITableViewController) - (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView;
...
// (UITableViewController) - (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section;
...
// (UITableViewController) - (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section;
...
// direct binding of: - (instancetype)initWithStyle:(UITableViewStyle)style;
- (instancetype) __init_crossmobile_ios_uikit_UITableViewController___int:(int) style 
{
    return [self initWithStyle:style];
}

// direct binding of: @property(nonatomic, strong) UITableView *tableView;
- (void) setTableView___crossmobile_ios_uikit_UITableView:(UITableView*) tableView 
{
...
// direct binding of: - (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
- (UITableViewCell*) cellForRowAtIndexPath___crossmobile_ios_uikit_UITableView_crossmobile_ios_foundation_NSIndexPath:(UITableView*) tableView :(NSIndexPath*) indexPath 
{
...
// direct binding of: - (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath;
- (double) heightForRowAtIndexPath___crossmobile_ios_uikit_UITableView_crossmobile_ios_foundation_NSIndexPath:(UITableView*) tableView :(NSIndexPath*) indexPath 
{
    return [self tableView:(tableView == JAVA_NULL ? nil : tableView) heightForRowAtIndexPath:(indexPath == JAVA_NULL ? nil : indexPath)];
}

// direct binding of: - (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section;
- (int) numberOfRowsInSection___crossmobile_ios_uikit_UITableView_int:(UITableView*) tableView :(int) section 
{
    return [self tableView:(tableView == JAVA_NULL ? nil : tableView) numberOfRowsInSection:section];
}

// direct binding of: - (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView;
- (int) numberOfSectionsInTableView___crossmobile_ios_uikit_UITableView:(UITableView*) tableView 
{
    return [self numberOfSectionsInTableView:(tableView == JAVA_NULL ? nil : tableView)];
}

// direct binding of: - (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section;
- (NSString*) titleForFooterInSection___crossmobile_ios_uikit_UITableView_int:(UITableView*) tableView :(int) section 
{
...
// direct binding of: - (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section;
- (NSString*) titleForHeaderInSection___crossmobile_ios_uikit_UITableView_int:(UITableView*) tableView :(int) section 
{
