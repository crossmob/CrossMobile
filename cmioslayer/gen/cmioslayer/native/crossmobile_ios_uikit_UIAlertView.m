...
// crossmobile.ios.uikit.UIAlertView implementation
...
// (UIAlertView) @property(nonatomic, assign) UIAlertViewStyle alertViewStyle;
...
// (UIAlertView) @property(nonatomic, weak) id delegate;
...
// (UIAlertView) @property(nonatomic, copy) NSString *message;
...
// (UIAlertView) @property(nonatomic, copy) NSString *title;
...
// (UIAlertView) - (NSInteger)addButtonWithTitle:(NSString *)title;
...
// (UIAlertView) - (UITextField *)textFieldAtIndex:(NSInteger)textFieldIndex;
...
// direct binding of: @property(nonatomic, assign) UIAlertViewStyle alertViewStyle;
- (void) setAlertViewStyle___int:(int) alertViewStyle 
{
...
// direct binding of: @property(nonatomic, weak) id delegate;
- (void) setDelegate___crossmobile_ios_uikit_UIAlertViewDelegate:(id<UIAlertViewDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: - (UITextField *)textFieldAtIndex:(NSInteger)textFieldIndex;
- (UITextField*) textFieldAtIndex___int:(int) textFieldIndex 
{
