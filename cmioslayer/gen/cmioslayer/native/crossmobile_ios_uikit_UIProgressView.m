...
// crossmobile.ios.uikit.UIProgressView implementation
...
// (UIProgressView) @property(nonatomic) float progress;
...
// (UIProgressView) @property(nonatomic, strong) UIColor *progressTintColor;
...
// (UIProgressView) @property(nonatomic) UIProgressViewStyle progressViewStyle;
...
// (UIProgressView) @property(nonatomic, strong) UIColor *trackTintColor;
...
// direct binding of: @property(nonatomic) float progress;
- (void) setProgress___float:(float) progress 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *progressTintColor;
- (void) setProgressTintColor___crossmobile_ios_uikit_UIColor:(UIColor*) progressTintColor 
{
...
// direct binding of: @property(nonatomic) UIProgressViewStyle progressViewStyle;
- (void) setProgressViewStyle___int:(int) progressViewStyle 
{
...
// direct binding of: @property(nonatomic, strong) UIColor *trackTintColor;
- (void) setTrackTintColor___crossmobile_ios_uikit_UIColor:(UIColor*) trackTintColor 
{
