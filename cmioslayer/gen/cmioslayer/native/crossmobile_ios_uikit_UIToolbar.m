...
// crossmobile.ios.uikit.UIToolbar implementation
...
// (UIToolbar) @property(nonatomic) UIBarStyle barStyle;
...
// (UIToolbar) @property(nonatomic, strong) UIColor *barTintColor;
...
// (UIToolbar) @property(nonatomic, copy) NSArray<UIBarButtonItem *> *items;
...
// (UIToolbar) @property(nonatomic, assign, getter=isTranslucent) BOOL translucent;
...
// (UIToolbar) - (void)setItems:(NSArray<UIBarButtonItem *> *)items animated:(BOOL)animated;
...
// direct binding of: @property(nonatomic, copy) NSArray<UIBarButtonItem *> *items;
- (void) setItems___java_util_List:(NSArray*) items 
{
...
// direct binding of: - (void)setItems:(NSArray<UIBarButtonItem *> *)items animated:(BOOL)animated;
- (void) setItems___java_util_List_boolean:(NSArray*) items :(BOOL) animated 
{
