...
// crossmobile.ios.uikit.UINavigationBar implementation
...
// (UINavigationBar) @property(nonatomic, readonly, strong) UINavigationItem *backItem;
...
// (UINavigationBar) @property(nonatomic, assign) UIBarStyle barStyle;
...
// (UINavigationBar) @property(nonatomic, strong) UIColor *barTintColor;
...
// (UINavigationBar) @property(nonatomic, weak) id<UINavigationBarDelegate> delegate;
...
// (UINavigationBar) @property(nonatomic, copy) NSArray<UINavigationItem *> *items;
...
// (UINavigationBar) @property(nonatomic, copy) NSDictionary<NSString *,id> *titleTextAttributes;
...
// (UINavigationBar) @property(nonatomic, readonly, strong) UINavigationItem *topItem;
...
// (UINavigationBar) @property(nonatomic, assign, getter=isTranslucent) BOOL translucent;
...
// (UINavigationBar) - (UINavigationItem *)popNavigationItemAnimated:(BOOL)animated;
...
// (UINavigationBar) - (void)pushNavigationItem:(UINavigationItem *)item animated:(BOOL)animated;
...
// (UINavigationBar) - (void)setItems:(NSArray<UINavigationItem *> *)items animated:(BOOL)animated;
...
// direct binding of: @property(nonatomic, readonly, strong) UINavigationItem *backItem;
- (UINavigationItem*) backItem__
{
...
// direct binding of: @property(nonatomic, assign) UIBarStyle barStyle;
- (void) setBarStyle___int:(int) barStyle 
{
...
// direct binding of: @property(nonatomic, weak) id<UINavigationBarDelegate> delegate;
- (void) setDelegate___crossmobile_ios_uikit_UINavigationBarDelegate:(id<UINavigationBarDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, copy) NSArray<UINavigationItem *> *items;
- (void) setItems___java_util_List:(NSArray*) items 
{
...
// direct binding of: @property(nonatomic, copy) NSDictionary<NSString *,id> *titleTextAttributes;
- (void) setTitleTextAttributes___java_util_Map:(NSDictionary*) titleTextAttributes 
{
...
// direct binding of: @property(nonatomic, readonly, strong) UINavigationItem *topItem;
- (UINavigationItem*) topItem__
{
...
// direct binding of: - (UINavigationItem *)popNavigationItemAnimated:(BOOL)animated;
- (UINavigationItem*) popNavigationItemAnimated___boolean:(BOOL) animated 
{
...
// direct binding of: - (void)pushNavigationItem:(UINavigationItem *)item animated:(BOOL)animated;
- (void) pushNavigationItem___crossmobile_ios_uikit_UINavigationItem_boolean:(UINavigationItem*) item :(BOOL) animated 
{
    [self pushNavigationItem:(item == JAVA_NULL ? nil : item) animated:animated];
}

// direct binding of: - (void)setItems:(NSArray<UINavigationItem *> *)items animated:(BOOL)animated;
- (void) setItems___java_util_List_boolean:(NSArray*) items :(BOOL) animated 
{
