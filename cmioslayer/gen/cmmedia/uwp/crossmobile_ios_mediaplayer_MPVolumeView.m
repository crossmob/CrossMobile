...
// crossmobile.ios.mediaplayer.MPVolumeView implementation
...
// (MPVolumeView) @property(nonatomic) BOOL showsRouteButton;
...
// (MPVolumeView) @property(nonatomic) BOOL showsVolumeSlider;
...
// direct binding of: @property(nonatomic) BOOL showsRouteButton;
- (void) setShowsRouteButton___boolean:(BOOL) showsRouteButton 
{
...
// direct binding of: @property(nonatomic) BOOL showsVolumeSlider;
- (void) setShowsVolumeSlider___boolean:(BOOL) showsVolumeSlider 
{
