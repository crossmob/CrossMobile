...
// crossmobile.ios.messageui.MFMailComposeViewController implementation
...
// (MFMailComposeViewController) @property(nonatomic, assign) id<MFMailComposeViewControllerDelegate> mailComposeDelegate;
...
// (MFMailComposeViewController) - (void)addAttachmentData:(NSData *)attachment mimeType:(NSString *)mimeType fileName:(NSString *)filename;
...
// (MFMailComposeViewController) - (void)setBccRecipients:(NSArray<NSString *> *)bccRecipients;
...
// (MFMailComposeViewController) - (void)setCcRecipients:(NSArray<NSString *> *)ccRecipients;
...
// (MFMailComposeViewController) - (void)setMessageBody:(NSString *)body isHTML:(BOOL)isHTML;
...
// (MFMailComposeViewController) - (void)setSubject:(NSString *)subject;
- (void) setSubject___java_lang_String:(NSString*) subject 
{
    [super setSubject:(subject == JAVA_NULL ? nil : subject)];
}

// (MFMailComposeViewController) - (void)setToRecipients:(NSArray<NSString *> *)toRecipients;
...
// direct binding of: + (BOOL)canSendMail;
+ (BOOL) canSendMail__
{
...
// direct binding of: @property(nonatomic, assign) id<MFMailComposeViewControllerDelegate> mailComposeDelegate;
- (void) setMailComposeDelegate___crossmobile_ios_messageui_MFMailComposeViewControllerDelegate:(id<MFMailComposeViewControllerDelegate>) mailComposeDelegate 
{
    objc_setAssociatedObject(self, @selector(setMailComposeDelegate:), mailComposeDelegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: - (void)addAttachmentData:(NSData *)attachment mimeType:(NSString *)mimeType fileName:(NSString *)filename;
- (void) addAttachmentData___crossmobile_ios_foundation_NSData_java_lang_String_java_lang_String:(NSData*) attachment :(NSString*) mimeType :(NSString*) filename 
{
...
// direct binding of: - (void)setBccRecipients:(NSArray<NSString *> *)bccRecipients;
- (void) setBccRecipients___java_util_List:(NSArray*) bccRecipients 
{
    [self setBccRecipients:(bccRecipients == JAVA_NULL ? nil : bccRecipients)];
}

// direct binding of: - (void)setCcRecipients:(NSArray<NSString *> *)ccRecipients;
- (void) setCcRecipients___java_util_List:(NSArray*) ccRecipients 
{
    [self setCcRecipients:(ccRecipients == JAVA_NULL ? nil : ccRecipients)];
}

// direct binding of: - (void)setMessageBody:(NSString *)body isHTML:(BOOL)isHTML;
- (void) setMessageBody___java_lang_String_boolean:(NSString*) body :(BOOL) isHTML 
{
    [self setMessageBody:(body == JAVA_NULL ? nil : body) isHTML:isHTML];
}

// direct binding of: - (void)setSubject:(NSString *)subject;
- (void) setSubject___java_lang_String:(NSString*) subject 
{
    [self setSubject:(subject == JAVA_NULL ? nil : subject)];
}

// direct binding of: - (void)setToRecipients:(NSArray<NSString *> *)toRecipients;
- (void) setToRecipients___java_util_List:(NSArray*) toRecipients 
{
