...
// crossmobile.ios.messageui.MFMessageComposeViewController implementation
...
// (MFMessageComposeViewController) @property(nonatomic, copy) NSString *body;
...
// (MFMessageComposeViewController) @property(nonatomic, assign) id<MFMessageComposeViewControllerDelegate> messageComposeDelegate;
...
// (MFMessageComposeViewController) @property(nonatomic, copy) NSArray<NSString *> *recipients;
...
// direct binding of: + (BOOL)canSendText;
+ (BOOL) canSendText__
{
...
// direct binding of: @property(nonatomic, copy) NSString *body;
- (void) setBody___java_lang_String:(NSString*) body 
{
...
// direct binding of: @property(nonatomic, assign) id<MFMessageComposeViewControllerDelegate> messageComposeDelegate;
- (void) setMessageComposeDelegate___crossmobile_ios_messageui_MFMessageComposeViewControllerDelegate:(id<MFMessageComposeViewControllerDelegate>) messageComposeDelegate 
{
    objc_setAssociatedObject(self, @selector(setMessageComposeDelegate:), messageComposeDelegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, copy) NSArray<NSString *> *recipients;
- (void) setRecipients___java_util_List:(NSArray*) recipients 
{
