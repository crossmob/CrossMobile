...
// crossmobile.ios.mapkit.MKOverlayView implementation
...
// (MKOverlayView) @property(nonatomic, readonly) id<MKOverlay> overlay;
...
// (MKOverlayView) - (BOOL)canDrawMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale;
...
// (MKOverlayView) - (void)drawMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale inContext:(CGContextRef)context;
...
// (MKOverlayView) - (MKMapPoint)mapPointForPoint:(CGPoint)point;
...
// (MKOverlayView) - (MKMapRect)mapRectForRect:(CGRect)rect;
...
// (MKOverlayView) - (CGPoint)pointForMapPoint:(MKMapPoint)mapPoint;
...
// (MKOverlayView) - (CGRect)rectForMapRect:(MKMapRect)mapRect;
...
// (MKOverlayView) - (void)setNeedsDisplayInMapRect:(MKMapRect)mapRect;
...
// (MKOverlayView) - (void)setNeedsDisplayInMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale;
...
// direct binding of: @property(nonatomic, readonly) id<MKOverlay> overlay;
- (id<MKOverlay>) overlay__
{
