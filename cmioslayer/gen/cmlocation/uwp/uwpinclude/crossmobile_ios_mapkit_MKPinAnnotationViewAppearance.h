...
// crossmobile.ios.mapkit.MKPinAnnotationViewAppearance definition
...
CM_EXPORT_CLASS
@interface crossmobile_ios_mapkit_MKPinAnnotationViewAppearance : crossmobile_ios_foundation_NSObject {
@public id $reference;
}
