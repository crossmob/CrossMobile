...
// crossmobile.ios.mapkit.MKAnnotationView implementation
...
// direct binding of: @property(nonatomic, strong) id<MKAnnotation> annotation;
- (void) setAnnotation___crossmobile_ios_mapkit_MKAnnotation:(id<MKAnnotation>) annotation 
{
...
// direct binding of: @property(nonatomic) CGPoint calloutOffset;
- (void) setCalloutOffset___crossmobile_ios_coregraphics_CGPoint:(crossmobile_ios_coregraphics_CGPoint*) calloutOffset 
{
...
// direct binding of: @property(nonatomic) BOOL canShowCallout;
- (void) setCanShowCallout___boolean:(BOOL) canShowCallout 
{
...
// direct binding of: @property(nonatomic) CGPoint centerOffset;
- (void) setCenterOffset___crossmobile_ios_coregraphics_CGPoint:(crossmobile_ios_coregraphics_CGPoint*) centerOffset 
{
...
// direct binding of: @property(nonatomic) MKAnnotationViewDragState dragState;
- (void) setDragState___int:(int) dragState 
{
...
// direct binding of: @property(nonatomic, getter=isDraggable) BOOL draggable;
- (void) setDraggable___boolean:(BOOL) draggable 
{
...
// direct binding of: @property(strong, nonatomic) UIView *leftCalloutAccessoryView;
- (void) setLeftCalloutAccessoryView___crossmobile_ios_uikit_UIView:(UIView*) leftCalloutAccessoryView 
{
...
// direct binding of: @property(nonatomic, readonly) NSString *reuseIdentifier;
- (NSString*) reuseIdentifier__
{
...
// direct binding of: @property(strong, nonatomic) UIView *rightCalloutAccessoryView;
- (void) setRightCalloutAccessoryView___crossmobile_ios_uikit_UIView:(UIView*) rightCalloutAccessoryView 
{
...
// direct binding of: - (void)setDragState:(MKAnnotationViewDragState)newDragState animated:(BOOL)animated;
- (void) setDragState___int_boolean:(int) newDragState :(BOOL) animated 
{
    [self setDragState:newDragState animated:animated];
}

// direct binding of: - (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (void) setSelected___boolean_boolean:(BOOL) selected :(BOOL) animated 
{
