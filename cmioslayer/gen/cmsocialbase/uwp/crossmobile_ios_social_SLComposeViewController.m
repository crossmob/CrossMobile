...
// crossmobile.ios.social.SLComposeViewController implementation
...
// (SLComposeViewController) @property(nonatomic, readonly) NSString *serviceType;
- (NSString*) serviceType__
{
    NSString* re$ult = [super serviceType];
    return [(re$ult ? re$ult : JAVA_NULL) retain];
}
...
// (SLComposeViewController) - (BOOL)addImage:(UIImage *)image;
- (BOOL) addImage___crossmobile_ios_uikit_UIImage:(UIImage*) image 
{
    return [super addImage:(image == JAVA_NULL ? nil : image)];
}

// (SLComposeViewController) - (BOOL)addURL:(NSURL *)url;
- (BOOL) addURL___crossmobile_ios_foundation_NSURL:(NSURL*) url 
{
    return [super addURL:(url == JAVA_NULL ? nil : url)];
}
...
// (SLComposeViewController) - (BOOL)removeAllImages;
- (BOOL) removeAllImages__
{
    return [super removeAllImages];
}

// (SLComposeViewController) - (BOOL)removeAllURLs;
...
// (SLComposeViewController) - (BOOL)setInitialText:(NSString *)text;
- (BOOL) setInitialText___java_lang_String:(NSString*) text 
{
    return [super setInitialText:(text == JAVA_NULL ? nil : text)];
}
...
// direct binding of: + (SLComposeViewController*)composeViewControllerForServiceType:(NSString *)serviceType;
...
// direct binding of: + (BOOL)isAvailableForServiceType:(NSString *)serviceType;
...
// direct binding of: @property(nonatomic, copy) SLComposeViewControllerCompletionHandler completionHandler;
...
// direct binding of: @property(nonatomic, readonly) NSString *serviceType;
- (NSString*) serviceType__
{
...
// direct binding of: - (BOOL)addImage:(UIImage *)image;
- (BOOL) addImage___crossmobile_ios_uikit_UIImage:(UIImage*) image 
{
    return [self addImage:(image == JAVA_NULL ? nil : image)];
}

// direct binding of: - (BOOL)addURL:(NSURL *)url;
- (BOOL) addURL___crossmobile_ios_foundation_NSURL:(NSURL*) url 
{
    return [self addURL:(url == JAVA_NULL ? nil : url)];
}

// direct binding of: - (BOOL)removeAllImages;
- (BOOL) removeAllImages__
{
    return [self removeAllImages];
}

// direct binding of: - (BOOL)removeAllURLs;
- (BOOL) removeAllURLs__
{
    return [self removeAllURLs];
}

// direct binding of: - (BOOL)setInitialText:(NSString *)text;
- (BOOL) setInitialText___java_lang_String:(NSString*) text 
{
