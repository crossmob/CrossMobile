...
// crossmobile.ios.quicklook.QLPreviewController implementation
...
// (QLPreviewController) @property(readonly) id<QLPreviewItem> currentPreviewItem;
- (id<QLPreviewItem>) currentPreviewItem__
{
    id<QLPreviewItem> re$ult = [super currentPreviewItem];
    return [(re$ult ? re$ult : JAVA_NULL) retain];
}

// (QLPreviewController) @property NSInteger currentPreviewItemIndex;
...
{
    return [super currentPreviewItemIndex];
}

// (QLPreviewController) @property(nonatomic, weak) id<QLPreviewControllerDataSource> dataSource;
...
{
    id<QLPreviewControllerDataSource> re$ult = [super dataSource];
    return [(re$ult ? re$ult : JAVA_NULL) retain];
}
...
// (QLPreviewController) @property(nonatomic, weak) id<QLPreviewControllerDelegate> delegate;
...
{
    id<QLPreviewControllerDelegate> re$ult = [super delegate];
    return [(re$ult ? re$ult : JAVA_NULL) retain];
}
...
// (QLPreviewController) - (void)refreshCurrentPreviewItem;
- (void) refreshCurrentPreviewItem__
{
    [super refreshCurrentPreviewItem];
}

// (QLPreviewController) - (void)reloadData;
- (void) reloadData__
{
    [super reloadData];
}
...
// direct binding of: + (BOOL)canPreviewItem:(id<QLPreviewItem>)item;
...
// direct binding of: @property(readonly) id<QLPreviewItem> currentPreviewItem;
- (id<QLPreviewItem>) currentPreviewItem__
{
...
// direct binding of: @property NSInteger currentPreviewItemIndex;
- (void) setCurrentPreviewItemIndex___int:(int) currentPreviewItemIndex 
{
...
// direct binding of: @property(nonatomic, weak) id<QLPreviewControllerDataSource> dataSource;
- (void) setDataSource___crossmobile_ios_quicklook_QLPreviewControllerDataSource:(id<QLPreviewControllerDataSource>) dataSource 
{
    objc_setAssociatedObject(self, @selector(setDataSource:), dataSource, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: @property(nonatomic, weak) id<QLPreviewControllerDelegate> delegate;
- (void) setDelegate___crossmobile_ios_quicklook_QLPreviewControllerDelegate:(id<QLPreviewControllerDelegate>) delegate 
{
    objc_setAssociatedObject(self, @selector(setDelegate:), delegate, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
// direct binding of: - (void)refreshCurrentPreviewItem;
- (void) refreshCurrentPreviewItem__
{
